...
const SignSel = async (req, res) => {
    try {
        ...
        const existingUser = await SelModels_1.SelUs.findOne({ email: email });
        const existingUser2 = await SelModels_1.SelUs.findOne({ number: number });
